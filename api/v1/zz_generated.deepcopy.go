...
func (in *NifiProperties) DeepCopyInto(out *NifiProperties) {
	*out = *in
	...
	if in.TLSAutoReload != nil {
		in, out := &in.TLSAutoReload, &out.TLSAutoReload
		*out = new(TLSAutoReloadConfig)
		**out = **in
	}
}
...
func (in *ReadOnlyConfig) DeepCopyInto(out *ReadOnlyConfig) {
	*out = *in
	...
	if in.AdditionalNifiEnvs != nil {
		in, out := &in.AdditionalNifiEnvs, &out.AdditionalNifiEnvs
		*out = make([]corev1.EnvVar, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSAutoReloadConfig) DeepCopyInto(out *TLSAutoReloadConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSAutoReloadConfig.
func (in *TLSAutoReloadConfig) DeepCopy() *TLSAutoReloadConfig {
	if in == nil {
		return nil
	}
	out := new(TLSAutoReloadConfig)
